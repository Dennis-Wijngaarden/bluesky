...
_GPSMESSAGE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='vn', full_name='GPSMessage.vn', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='ve', full_name='GPSMessage.ve', index=6,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='vd', full_name='GPSMessage.vd', index=7,
...
_AVOIDANCEVELOCITY = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='vn', full_name='AvoidanceVelocity.vn', index=1,
      number=2, type=17, cpp_type=1, label=2,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='ve', full_name='AvoidanceVelocity.ve', index=2,
      number=3, type=17, cpp_type=1, label=2,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='vd', full_name='AvoidanceVelocity.vd', index=3,
      number=4, type=17, cpp_type=1, label=2,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
