...
for i in range(parameters.N_missions):
    ...
    for j in range(parameters.N_RS):
        ...
        # Write scenario files
        scn_TS0.write(cre_line_wind_calm + conf_line_wind_calm + bank_limit_lines + flyturn_lines + wpt_lines_wind_calm + gf_lines_wind_calm)
        scn_TS1.write(common_lines + cre_line_wind_calm + conf_line_wind_calm + bank_limit_lines + flyturn_lines + wpt_lines_wind_calm)
        scn_TS2.write(common_lines + cre_line_wind_calm + conf_line_wind_calm + bank_limit_lines + flyturn_lines + wpt_lines_wind_calm + gf_lines_wind_calm)
        scn_TS3.write(common_lines + wind_line + cre_line_wind + conf_line_wind + bank_limit_lines + flyturn_lines + wpt_lines_wind)
        scn_TS4.write(common_lines + wind_line + cre_line_wind + conf_line_wind + bank_limit_lines + flyturn_lines + wpt_lines_wind + gf_lines_wind)
