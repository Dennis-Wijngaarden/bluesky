...
for i in range(parameters.N_missions):
    ...
    scn_TS0 = open(loc_TS0 + "/test" + str(i) + ".scn", "w")
    ...
    conf_line_wind_calm = "00:00:00.00>CRE UAV1 UAV_" + str(i) + "_1 " + str(start_lat1_nowind) + " " + str(start_lon1_nowind) + " " + str(scenario_data[i]['trk0']) + " " +\
    ...
    scn_TS1.write(cre_line_wind_calm + conf_line_wind_calm + bank_limit_lines + flyturn_lines + wpt_lines)
    scn_TS2.write(cre_line_wind_calm + conf_line_wind_calm + bank_limit_lines + flyturn_lines + wpt_lines + gf_lines)
    scn_TS3.write(wind_line + cre_line_wind + conf_line_wind + bank_limit_lines + flyturn_lines + wpt_lines)
    scn_TS4.write(wind_line + cre_line_wind + conf_line_wind + bank_limit_lines + flyturn_lines + wpt_lines + gf_lines)
